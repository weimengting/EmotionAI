...
%75%(²»ÓÃpca)
%[1,0.5,0.5,1,1,0.5,1,0.5,0.5,0.5,1,1,1,0.5,1,0.5,0.5,0.5,0.5,1,1,1]

clc;
clear;

S_Feature = load('F:\Codes\LBP-TOP\4Frames_Features\An\An_An_Feature.mat');
S_Feature = S_Feature.An_An_Feature;

P_Feature = load('F:\Codes\LBP-TOP\4Frames_Features\An\Ha_An_Feature.mat');
P_Feature = P_Feature.Ha_An_Feature;
