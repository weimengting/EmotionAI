...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for c_idx in clip_idxes:
            ...
            tgt_img_pil = cv2.imread(tgt_img_path, cv2.IMREAD_GRAYSCALE)
            tgt_img_pil = cv2.resize(tgt_img_pil, (self.image_size, self.image_size))
        ...
        tgt_vidpil_lst = np.stack(tgt_vidpil_lst)
        return tgt_vidpil_lst, label  # [16, 3, 256, 256]
